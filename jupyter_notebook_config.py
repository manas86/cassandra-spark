...
c.NotebookApp.certfile = '/opt/notebook/certs/<certificate>.pem'
...
c.NotebookApp.keyfile = '/opt/notebook/certs/<certificate>.key'
...
c.NotebookApp.password = u'sha1:<hash-password>'
